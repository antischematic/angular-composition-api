...
describe("Store", () => {
   ...
   describe("Utils", () => {
      it("should filter actions by kind", () => {
         ...
         store.pipe(kindOf(Kind)).subscribe(spy)
      ...
      it("should map data to actions", () => {
         ...
         of(10, 20, 30).pipe(action(Update)).subscribe(store)
      ...
      it("should map errors to actions", () => {
         ...
         throwError(new Error()).pipe(action(Update, Failure)).subscribe(spy)
   ...
   describe("Composition API", () => {
      it("should run effects with Angular Composition API", () => {
         ...
         const RUN = new InjectionToken("RUN", {
            factory() {
